...
(//) :: Ix a => Array a b -> [(a,b)] -> Array a b | colors // [(0,White) (7,Black)] mkHorWall, mkVerWall :: Int -> Int -> Int -> [(Position,[Direction])] mkHorWall x1 x2 y
  = [ ((x,y),  nb) | x <- [x1..x2] ] ++
    [ ((x,y+1),sb) | x <- [x1..x2] ]
...
accum :: (Ix a) => (b->c->b) -> Array a b -> [(a,c)] -> Array a b | [South, East, West] `intersect` [North, South, West] | ===> [South, West]
